...
$time_interval        = "5000"; // time between slides, in miliseconds
...
$text_font_size       = "11"; // input caption text font size, in pixels
...
<html>
    ...
    <body onLoad="javascript:void(viewer.show(0))";>
