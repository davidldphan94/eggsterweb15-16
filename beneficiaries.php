...
Please upload new beneficiary documents. This is so potential organizations who PCR did not mail presonally who want to apply can apply. We've gotten some good beneficiaries that way.
    ...
    1) Download the file.
    2) Open WinSCP and double click on "misc" folder and then "docs" folder. This should open up the docs folder and you should see past files inside.
    3) (optional) Delete old files if it seems too crowded.
    4) Drag and drop files into this folder. Verify that the files are actually there.
    5) Change the below URLs (for example, "./misc/docs/Eggster Beneficiary Application 2014.pdf") to reflect current files.
        So let's say that the new beneficiary file is called Eggster Beneficiary App 2015.pdf
        The URL below should read "./misc/docs/Eggster Beneficiary App 2015.pdf". The entire code should be: 
        <a href="./misc/docs/Eggster Beneficiary Application 2014.pdf" target="_blank">2014 Beneficiary Application</a>
    6) Test website to make sure the proper files are being linked.
    7) If there's a problem, ask web-savvy or previous SHA for help.-->
<!--2013-2014 Beneficiary Forms:<br />
<a href="./misc/docs/Eggster Beneficiary Application 2014.pdf" target="_blank">2014 Beneficiary Application</a><br>
<a href="./misc/docs/Eggster Beneficiary Cover Letter 2014.pdf" target="_blank">2014 Beneficiary Letter</a><br><br>-->
